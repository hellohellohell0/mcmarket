        ...
        <div className={`container ${styles.pageContainer}`}>
            <GlassCard className={styles.card}>
                ...
                <p className={styles.bodyText}>
                    Glass Market is an account marketplace made by Reprising for the purpose of browsing, selling, and buying accounts easily. It includes a simple interface and functionality, as well as a detailed filtering system to tailor results to your liking.
                </p>
                <p className={styles.bodyText}>
